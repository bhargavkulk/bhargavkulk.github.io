...
- Formalized Skia's 2D rasterization semantics in Lean and built a verified
  optimizer that achieves an average speedup of 18.7% across the top 100 websites
  by traffic.
...
- Built a floating-point debugger combining double-double arithmetic, condition
  numbers, and logarithmic oracles, achieving 80.0% precision and 96.1% recall
  on 546 difficult numeric benchmarks.
