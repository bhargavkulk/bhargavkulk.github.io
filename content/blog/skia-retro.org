...
#+date: [2026-06-16 Tue]
#+template: post.mako
#+description: A retrospective on optimizing the Skia Graphics API.
...
Turns out Pavel already wrote a blog post titled [[https://pavpanchekha.com/blog/skia-egraph.html]["Speeding up Skia using E-graphs"]] a while back.
